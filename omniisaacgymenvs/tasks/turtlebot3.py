...
class Turtlebot3Task(RLTask):
    def __init__(
        ...
        self._diff_controller = DifferentialController(name="simple_control",wheel_radius=0.033, wheel_base=0.160)
    ...
    def add_prims_to_stage(self, scene):
        ...
        turtlebot3_asset_path="/home/isaac_user/.local/share/ov/pkg/isaac_sim-2022.2.1/ros_workspace/src/turtlebot3/turtlebot3.usd"
        ...
        scene.add(
            WheeledRobot(
                ...
                create_robot=True,
                usd_path=turtlebot3_asset_path,
